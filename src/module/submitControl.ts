...
function createCodeHash(source_code: any) {
	const hash = crypto.createHash("md5");
	return hash.update(source_code).digest("hex");
}

async function problemInFutureOrCurrentContest(problem_id: any) {
...
async function contestIsStart(contest_id: any) {
...
async function getLangmaskForContest(contest_id: any) {
...
async function getLangmaskForTopic(topic_id: any) {
...
async function checkContestPrivilege(req: any, contest_id: any) {
...
async function limitAddressForContest(connection: any, req: any, contest_id: any) {
...
async function limitClassroomAccess(connection: any, req: any, contest_id: any) {
	const ip = getIP(req);
...
async function checkTopicPrivilege(req: any, topic_id: any) {
...
async function includeProblem(id: any, num: any, sql: any) {
...
async function contestIncludeProblem(contest_id: any, num: any) {
...
async function TopicIncludeProblem(topic_id: any, num: any) {
...
async function problemPublic(problem_id: any) {
...
async function makePrependAndAppendCode(problem_id: any, source: any, language: any) {
...
function checkLangmask(language: any, langmask: any = LANGMASK) {
	return Boolean((~langmask) & (2 ** language));
}

async function checkContestValidate(connection: any, req: any, originalContestID: any, originalPID: any, language: any) {
...
async function prepareRequest(req: any, cookie: any) {
...
function dataErrorChecker(data: any) {
	if (!data) {
...
function classifySubmissionType(data: any) {
...
function dos2unix(plainText: any) {
...
async function insertTransaction(connection: any, { result, source_code, source_code_user, data }: any, testRun: any) {
...
async function normalSubmissionTransaction(connection: any, req: any, data: any) {
...
module.exports = async function (req: any, data: any, cookie: any) {
