...
let source_browser: any = {};
let contest_member: any = {};
let problem_creator: any = {};
let editor: any = {};
let contest_manager: any = {};

let privilegeSet: any = {
	administrator,
	source_browser,
	contest_member,
	problem_creator,
...
function checkPrivilegeSetExist(privilegeName: string) {
	return Boolean(privilegeSet[privilegeName]);
}

function addPrivilege(user_id: string, privilegeName: string) {
...
function removePrivilege(user_id: string, privilegeName: string) {
	if (!checkPrivilegeSetExist(privilegeName)) {
		return false;
...
export = { init_privilege, addPrivilege, removePrivilege, refreshPrivilege };
