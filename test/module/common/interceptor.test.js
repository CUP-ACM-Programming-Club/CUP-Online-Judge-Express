...
const InterceptorFactory = require("../../../module/common/interceptor");
...
describe("ConfigManager Interceptor Factory", function () {
    it('should call next() when Switch is on', function (done) {
        const interceptor = InterceptorFactory.newInstance().setSwitchKey("test_switch").setDefaultValue(ConfigManager.SWITCH_ON).build();
    ...
    it('should pass validate because user is admin', function (done) {
        const interceptor = InterceptorFactory.newInstance()
